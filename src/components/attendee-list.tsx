    ...
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
        ...
        >
          ...
          <input className="bg-transparent flex-1 outline-none border-0 p-0 text-sm" placeholder="Burcar participantes" />
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border border-white/10">
              ...
              <th className="py-3 px-4 text-sm font-semibold text-left">Data de inscrições</th>
              <th className="py-3 px-4 text-sm font-semibold text-left">Date do check-in</th>
              <th style={{ width: 64 }} className="py-3 px-4 text-sm font-semibold text-left"></th>
            </tr>
          </thead>
          <tbody>
            {Array.from({ length: 8 }).map((_, i) => (
              <tr key={i} className="border border-white/10 hover:bg-white/10">
                ...
                <td className="py-3 px-4 text-sm text-zinc-300">
                  <div className="flex flex-col gap-1">
                    <span className="font-semibold text-white">clepson lacerda</span>
                    <span>clepson@bvb.com</span>
                  </div>
                </td>
